...
/**
 * A JavaFX application that provides a graphical user interface for managing a to-do list.
 */
public class ToDoListGUI extends Application {
     ...
     *
     * @param descriptionField the TextField for the task description
     * @param dueDatePicker    the DatePicker for the task due date
     * @param completedCheckBox the CheckBox for the task completion status
     */
